<template>
    <div class="pagination">
        <ul>
            ...
            <!-- 页数( v-for ) -->
            <li class="pages" v-for="(item, index) in pages" v-bind:key="index">
                <span>{{ item }}</span>
            </li>
            <!-- 后一页 -->
            <li>
    ...
    computed: {
        pages() {
            ...
            elseif(currentPage > totalPages - 4) {
                return [1, "...", totalPages - 9, totalPages - 8, totalPages - 7, totalPages - 6, totalPages - 5, totalPages - 4, totalPages - 3, totalPages - 2, totalPages - 1, totalPages];
            }
        },
    },
    setup() {},
